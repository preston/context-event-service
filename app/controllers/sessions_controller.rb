class SessionsController < OpenIdConnectController

	skip_authorization_check

	skip_before_filter	:check_eula_acceptance # needs to happen *after* authentication.
...
logger.debug jwt
			...
			if identity.nil?
				...
				else # the user is already logged in and thus already has a User record.
				end
