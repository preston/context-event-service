...
class CapabilitiesControllerTest < ActionController::TestCase
  ...
  test "should create capability" do
    assert_difference('Capability.count') do
      post :create, capability: { entity_id: @capability.entity_id, entity_type: @capability.entity_type, role_id: @capability.role_id }
    end
  ...
  test "should update capability" do
    patch :update, id: @capability, capability: { entity_id: @capability.entity_id, entity_type: @capability.entity_type, role_id: @capability.role_id }
    assert_redirected_to capability_path(assigns(:capability))
  end
